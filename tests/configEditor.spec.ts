...
import { CDFLoginOptions, MySecureJsonData } from '../src/types';
...
test('"Save & test" should be successful when configuration is valid', async ({
  ...
  const ds = await readProvisionedDataSource<CDFLoginOptions, MySecureJsonData>({ fileName: 'datasources.yml' });
